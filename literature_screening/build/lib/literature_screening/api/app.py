...
from literature_screening.api.schemas import DatasetRecord, FulltextBatchStatusUpdateRequest, FulltextQueueItem, FulltextQueueRebuildRequest, FulltextStatusUpdateRequest, ProjectCreate, ProjectDetail, ProjectSnapshot, ProjectUpdate, ProjectWorkbench, ProjectWorkflowUpdate, StrategyPlan, WorkbenchBatchPatchRequest, WorkbenchCandidateItem, WorkbenchItemPatchRequest, WorkbenchLink, WorkbenchRebuildRequest, WorkbenchScreeningEvent, WorkbenchSummary
...
def _workbench_to_fulltext_items(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for item in items:
        ...
        converted.append(
            {
                "paper_id": item.get("candidate_id"),
