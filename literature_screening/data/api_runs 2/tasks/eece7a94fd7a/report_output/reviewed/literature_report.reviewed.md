...
[1] TSAI M F, HUANG J Y. Sentiment analysis of pets using deep learning technologies in artificial intelligence of things system[J]. Soft Computing, 2021, 25(21): 13741-13752.
[2] MARTVEL G, LAZEBNIK T, FEIGHELSTEIN M, et al. Automated landmark-based cat facial analysis and its applications[J]. Frontiers in Veterinary Science, 2024, 11: 1442634.
[3] CHEN G Y, TAKEGAWA Y, MATSUMURA K, et al. Cat and Dog Behavior Recognition Method Using Deep Learning Approach Based on Inertial Measurement Unit Sensor Data[J]. Sensors and Materials, 2025, 37(3): 1073.
[4] TANG L, HU S P, YANG C J, et al. JL-TFMSFNet: A domestic cat sound emotion recognition method based on jointly learning the time–frequency domain and multi-scale features[J]. Expert Systems with Applications, 2024, 255: 124620.
[5] MARTVEL G, LAZEBNIK T, FEIGHELSTEIN M, et al. Automated video-based pain recognition in cats using facial landmarks[J]. Scientific Reports, 2024, 14(1): 28006.
[6] FEIGHELSTEIN M, HENZE L A, MELLER S, et al. Explainable automated pain recognition in cats[J]. Scientific Reports, 2023, 13(1): 8973.
[7] FEIGHELSTEIN M, SHIMSHONI I, FINKA L R, et al. Automated recognition of pain in cats[J]. Scientific Reports, 2022, 12(1): 9575.
[8] BONEH-SHITRIT T, FINKA L, MILLS D S, et al. A segment-based framework for explainability in animal affective computing[J]. Scientific Reports, 2025, 15(1): 13670.
