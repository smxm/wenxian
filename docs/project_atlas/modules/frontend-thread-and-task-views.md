...
| `literature_screening_web/src/views/ProjectDetailView.vue` | thread home, stage actions, project-level review/report surfaces |
| `literature_screening_web/src/views/StrategyRunView.vue` | strategy kickoff and refresh flow |
| `literature_screening_web/src/views/ScreeningRunView.vue` | screening form, source selection, and round naming |
| `literature_screening_web/src/views/TaskDetailView.vue` | task progress, review, task edit/delete controls, stop/snapshot display, artifacts, and report launch |
