...
| `literature_screening_web/src/views/ProjectDetailView.vue` | project-level report launch from chosen datasets |
...
- change report launch UI or model options
...
- `PYTHONPATH=/Users/mao/Documents/langchain/literature_screening/src /Users/mao/Documents/langchain/literature_screening/.venv311-codex/bin/python -m pytest literature_screening/separated_modules/formal_report_module/tests/test_simple_report.py literature_screening/tests/test_api_app.py`
